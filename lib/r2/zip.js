        ...
        while (true) {
          ...
          try {
            ...
            await new Promise((resolve, reject) => {
              // Note: archiver processes appends sequentially internally, 
              // but we await here to control how many R2 streams are open simultaneously.
              archive.append(res.Body, { name: entryName }, (err) => {
                if (err) reject(err);
                else resolve();
              });
            });
